    ...
    public partial class test : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostsReaction", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PostsReaction_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostsReaction_Reactions_ReactionId",
                        column: x => x.ReactionId,
                        principalTable: "Reactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostsReaction_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostsReaction_PostId",
                table: "PostsReaction",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_PostsReaction_ReactionId",
                table: "PostsReaction",
                column: "ReactionId");

            migrationBuilder.CreateIndex(
                name: "IX_PostsReaction_UserId",
                table: "PostsReaction",
                column: "UserId");
