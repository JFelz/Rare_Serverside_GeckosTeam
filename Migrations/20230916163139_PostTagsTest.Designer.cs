...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rare_Serverside_GeckosTeam.Models.PostTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Rare_Serverside_GeckosTeam.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2023, 9, 6, 12, 31, 39, 709, DateTimeKind.Local).AddTicks(6677),
                            EndedOn = new DateTime(2023, 9, 16, 12, 31, 39, 709, DateTimeKind.Local).AddTicks(6704),
                            FollowerId = 1,
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2023, 6, 16, 12, 31, 39, 709, DateTimeKind.Local).AddTicks(6707),
                            EndedOn = new DateTime(2023, 9, 16, 12, 31, 39, 709, DateTimeKind.Local).AddTicks(6710),
                            FollowerId = 2,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2022, 9, 16, 12, 31, 39, 709, DateTimeKind.Local).AddTicks(6712),
                            EndedOn = new DateTime(2023, 9, 16, 12, 31, 39, 709, DateTimeKind.Local).AddTicks(6714),
                            FollowerId = 3,
                            UserId = 3
                        });
                });
            ...
            modelBuilder.Entity("Rare_Serverside_GeckosTeam.Models.PostTag", b =>
                {
                    ...
                    b.HasOne("Rare_Serverside_GeckosTeam.Models.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
